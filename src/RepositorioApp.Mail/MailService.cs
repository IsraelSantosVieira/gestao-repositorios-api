...
namespace RepositorioApp.Mail
{
    public class MailService : IMailService
    {
        ...
        {
            Send(_config.From, _config.FromName, emailTo, subject, bodyMessage, isBodyHtml, cc, bcc, atch, replyTo, atchBin);
        }
            ...
            IDictionary<string, byte[]> atchBin = null)
        {
            ...
            //mailMessage.AlternateViews.Add(AlternateView.CreateAlternateViewFromString(bodyMessage, null, "text/plain"));
